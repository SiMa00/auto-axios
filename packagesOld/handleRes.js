...
let ErrorMap = {}
const getMsgByCode = (respDataCode) => {
    const retMsgObj = ErrorMap[respDataCode + '']
    return (retMsgObj && retMsgObj.retMsg) || 'ErrMapCodeMissing' // 错误码映射缺失
}

// 处理返回数据
export const getRetData = (response) => {
...
// 全局错误消息提示处理
export function resHandler(response, errorMsgFlag, pendingRequest) {
